# -*- coding: utf-8 -*-
"""
Created on Tue Aug  1 13:40:13 2017
...
def bullseye_plot(ax, data, segBold=None, cmap=None, norm=None):
    ...
    for i in range(6):
        ...
        if i+1 in segBold:
            ax.plot(theta0, r0, '-k', lw=linewidth+3, color = 'r')
            ax.plot(theta0[0], [r[2], r[3]], '-k', lw=linewidth+2, color = 'r')
            ax.plot(theta0[-1], [r[2], r[3]], '-k', lw=linewidth+2, color = 'r')
    ...
    for i in range(6):
        ...
        if i+7 in segBold:
            ax.plot(theta0, r0, '-k', lw=linewidth+3, color = 'r')
            ax.plot(theta0[0], [r[1], r[2]], '-k', lw=linewidth+2, color = 'r')
            ax.plot(theta0[-1], [r[1], r[2]], '-k', lw=linewidth+2, color = 'r')
    ...
    for i in range(4):
        ...
        if i+13 in segBold:
            ax.plot(theta0, r0, '-k', lw=linewidth+3, color = 'r')
            ax.plot(theta0[0], [r[0], r[1]], '-k', lw=linewidth+2, color = 'r')
            ax.plot(theta0[-1], [r[0], r[1]], '-k', lw=linewidth+1, color = 'r')
