...
\begin{document}
 \begin{tikzpicture}\tikzstyle{every node}=[font=\huge]
   ...
   \drawsector[draw=blue, thick, fill=blue]{3.5cm}{1cm}{60}{60}{}
   \drawsector[draw=red, thick, fill=red]{3.5cm}{1cm}{120}{60}{}
   \drawsector[draw=green, thick, fill=green]{3.5cm}{1cm}{180}{60}{}
   \drawsector[draw=cyan, thick, fill=cyan!70]{3.5cm}{1cm}{240}{60}{}
   \drawsector[draw=purple, thick, fill=purple!70]{3.5cm}{1cm}{300}{60}{}
   \drawsector[draw=yellow, thick, fill=yellow]{3.5cm}{1cm}{360}{60}{}
